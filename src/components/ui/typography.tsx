...
const Typography: FC<TypographyProps> = ({
  ...
  const classNames = {
    ...
    h4: "scroll-m-10 text-4xl, font-medium, tracking-tight, lg:text-52l",
    h5: "scroll-m-8 text-4xl, font-normal, tracking-tight, lg:text-xl",
    h6: "scroll-m-6 text-4xl, font-normal, tracking-tight, lg:text-xl",
    p: "scroll-m-4 text-4xl, font-normal, tracking-tight, lg:text-base",
  };
  const Tag = variant;
